...
public class ServiceObjectDetailsControllerIntegrationTest {

    MockMvc mockMvc;

    @InjectMocks
    ServiceObjectDetailsController serviceObjectDetailsController;
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc = standaloneSetup(serviceObjectDetailsController)
    ...
    public void requestEntityHttpOkTest() throws Exception {
        PowerMockito.doReturn(serviceObjectResponseMessage())
                .when(serviceObjectService)
                .getEntity(any(GetServiceInstanceEvent.class));

        this.mockMvc.perform(
                get("/idm/serviceobject/testId").headers(
                        authorizationHttpHeaderToken()).accept(
                        MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }

    @Test
    public void requestServiceObjectIdmExceptionTest() throws Exception {
        PowerMockito
                .doThrow(
    ...
    @Test
    public void requestEntityComponentHttpOkTest() throws Exception {
        PowerMockito.doReturn(serviceObjectResponseMessage())
                .when(serviceObjectService)
                .getEntity(any(GetServiceInstanceEvent.class));

        this.mockMvc.perform(
                get("/idm/serviceobject/api_token_data/testId").headers(
                        authorizationHttpHeaderToken()).accept(
                        MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }

    @Test
    public void requestServiceObjectComponentIdmExceptionTest()
            throws Exception {
        PowerMockito
                .doThrow(
                        new IdManagementException(null, null, LoggerFactory
