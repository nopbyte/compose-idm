...
public class AttributeValueDetailsControllerTest {
    ...
    public void tearDown() {
        ...
        HttpHeaders tokenHeader = new HttpHeaders();
        tokenHeader.set("Authorization", "Bearer " + accessToken);
        tokenHeader.set("If-Unmodified-Since",
                String.valueOf(groupLastModified));
    ...
    @Test
    public void attributeValuesDetailsTest() {
        ...
        header.set("Authorization", "BEARER " + accessToken);
        HttpEntity<String> simpleHeader = new HttpEntity<String>(header);
        
        ResponseEntity<Object> responseEntityValueDetails = restTemplate
                .exchange(URL + "idm/attribute_values/approve/", HttpMethod.GET,
                        simpleHeader, Object.class);
        
        ArrayList<String> res =   (ArrayList<String>) responseEntityValueDetails.getBody();
    ...
    @Test
    public void AnonymousattributeValuesDetailsTest() {
        ...
        tokenHeader.set("If-Unmodified-Since",
                String.valueOf(groupLastModified));
        HttpEntity<String> deleteEntityGroup = new HttpEntity<String>(
                tokenHeader);
