...
public class ServiceInstanceDetailsControllerIntegrationTest {

    MockMvc mockMvc;

    @InjectMocks
    ServiceInstanceDetailsController serviceInstanceDetailsController;
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc = standaloneSetup(serviceInstanceDetailsController)
    ...
    public void requestEntityHttpOkTest() throws Exception {
        PowerMockito.doReturn(serviceInstanceResponseMessage())
                .when(serviceInstanceService)
                .getEntity(any(GetServiceInstanceEvent.class));

        this.mockMvc.perform(
                get("/idm/serviceinstance/testId").headers(
                        authorizationHttpHeaderToken()).accept(
                        MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }

    @Test
    public void requestServiceInstanceIdmExceptionTest() throws Exception {
        PowerMockito
                .doThrow(
