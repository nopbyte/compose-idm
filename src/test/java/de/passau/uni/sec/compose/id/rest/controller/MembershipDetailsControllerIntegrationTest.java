...
public class MembershipDetailsControllerIntegrationTest {

    MockMvc mockMvc;

    @InjectMocks
    MembershipDetailsController membershipDetailsController;
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc = standaloneSetup(membershipDetailsController)
    ...
    public void requestEntityHttpOkTest() throws Exception {
        ...
        this.mockMvc.perform(
                get("/idm/memberships/users/").headers(
