...
public class ApplicationDetailsControllerIntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc = standaloneSetup(applicationDetailsController)
    ...
    public void requestEntityHttpOkTest() throws Exception {
        PowerMockito
                ...
                .getEntity(any(GetApplicationEvent.class));

        this.mockMvc.perform(
                get("/idm/application/test").headers(authorizationHttpHeader())
                        .accept(MediaType.APPLICATION_JSON)).andExpect(
                status().isOk());
    }

    @Test
    public void requestApplicationIdmExceptionTest() throws Exception {
        PowerMockito
                .doThrow(
    ...
    @Test
    public void requestApplicationRenderAsJsonTest() throws Exception {
        PowerMockito
                .doReturn(
        ...
        this.mockMvc
                .perform(
                        get("/idm/application/test").headers(
                                authorizationHttpHeader()).accept(
