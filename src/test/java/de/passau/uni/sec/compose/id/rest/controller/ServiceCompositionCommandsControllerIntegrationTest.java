...
import static de.passau.uni.sec.compose.id.rest.controller.fixture.RestDataFixture.serviceCompositionCreateMessageJSON;
...
public class ServiceCompositionCommandsControllerIntegrationTest {

    MockMvc mockMvc;

    @InjectMocks
    ServiceCompositionCommandsController serviceCompositionCommandsController;
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc = standaloneSetup(serviceCompositionCommandsController)
    ...
    public void createEntityHttpCreatedTest() throws Exception {
        Date date = new Date();
        PowerMockito
                .doReturn(serviceCompositionResponseMessage("testId", date))
                .when(serviceCompositionService)
                .createEntity(any(CreateServiceCompositionEvent.class));

        this.mockMvc.perform(
                post("/idm/servicecomposition/")
                        .headers(authorizationHttpHeader())
                        .content(serviceCompositionCreateMessageJSON())
    ...
    @Test
    public void createServiceCompositionRenderAsJsonTest() throws Exception {
        Date date = new Date();
        PowerMockito
                .doReturn(serviceCompositionResponseMessage("testId", date))
                .when(serviceCompositionService)
    ...
    @Test
    public void createServiceCompostionIdmExceptionTest() throws Exception {
        PowerMockito
                .doThrow(
    ...
    public void changeEntityHttpNotImplemented() throws Exception {
        this.mockMvc.perform(
                put("/idm/servicecomposition/testId")
    ...
    public void deleteEntityHttpOkTest() throws Exception {
        PowerMockito.doNothing().when(serviceCompositionService)
                .deleteEntity(any(DeleteServiceCompositionEvent.class));

        this.mockMvc.perform(
                delete("/idm/servicecomposition/testId")
                        .headers(tokenUnmodifiedHttpHeader())
