...
public class DeleteServiceObjectEvent extends AbstractUpdateEvent implements Event
{
	
	
	private static Logger LOG = LoggerFactory.getLogger(DeleteServiceObjectEvent.class);
	
	
		public DeleteServiceObjectEvent(String id,  Collection<IPrincipal> principals, long lastKnownUpdate)
	{
		super.entityId = id;
