...
@Controller
@RequestMapping("/idm/group_attributes")
public class ListAttibutesInGroupDetailsController {
private static Logger LOG = LoggerFactory.getLogger(ListAttibutesInGroupDetailsController.class);
    ...
    public @ResponseBody ResponseEntity<Object> getMembershipsUser(   @RequestHeader("Authorization") String token,
			...
			cred.add(token);
		    	try{
    				 ...
    				 Object obj= attributeService.listAllEntities(new ListAttributesInGroupEvent(principals,uid));
