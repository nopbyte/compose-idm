...
private static Logger LOG = LoggerFactory.getLogger(MembershipDetailsController.class);
	
	@Autowired
    private UserMembershipService memberships;
    ...
    public @ResponseBody ResponseEntity<Object> getMembershipsUser( @RequestHeader("Authorization") String token,
    		UriComponentsBuilder builder){
    			...
    			try{
    				 ...
    				 Object obj= memberships.listAllEntities(new ListPendingUserMembershipsEvent(principals));
