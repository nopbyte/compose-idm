...
public class DeleteAttributeValueEvent extends AbstractUpdateEvent implements Event
{
	
	
	private static Logger LOG = LoggerFactory.getLogger(DeleteAttributeValueEvent.class);
	
	
		public DeleteAttributeValueEvent(String id,  Collection<IPrincipal> principals, long lastKnownUpdate)
	{
		super.entityId = id;
	...
	public String getLoggingDetails() {
			...
			return "Deleting attribute value with id: "+entityId + " principals: "+RestAuthentication.getBasicInfoPrincipals(principals);
