...
public class DeleteServiceCompositionEvent extends AbstractUpdateEvent implements Event
{
	
	
	private static Logger LOG = LoggerFactory.getLogger(DeleteServiceCompositionEvent.class);
	
	
		public DeleteServiceCompositionEvent(String id,  Collection<IPrincipal> principals, long lastKnownUpdate)
	{
		super.entityId = id;
