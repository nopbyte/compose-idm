...
private static Logger LOG = LoggerFactory.getLogger(ApplicationDetailsController.class);
    ...
    public @ResponseBody ResponseEntity<Object> getUser( @RequestHeader("Authorization") String token,
    		@PathVariable(value="Id") String uid,UriComponentsBuilder builder){
    			...
    			try{
		    		 ...
		    		 EntityResponseMessage res = applicationService.getEntity(new GetApplicationEvent(uid,principals));
