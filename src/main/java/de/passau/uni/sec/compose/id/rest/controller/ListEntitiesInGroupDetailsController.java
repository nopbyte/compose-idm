...
@Controller
@RequestMapping("/idm/group_entities")
public class ListEntitiesInGroupDetailsController {
private static Logger LOG = LoggerFactory.getLogger(ListEntitiesInGroupDetailsController.class);
	...
	@Autowired
	private ListEntitiesGroupService listEntitiesService;
    ...
    public @ResponseBody ResponseEntity<Object> getMembershipsUser(   @RequestHeader("Authorization") String token,
			...
			cred.add(token);
		    	try{
    				 ...
    				 Object obj= listEntitiesService.listAllEntities(new ListEntitiesInGroupEvent(principals,uid));
