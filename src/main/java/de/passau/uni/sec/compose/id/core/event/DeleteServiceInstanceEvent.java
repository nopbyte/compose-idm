...
public class DeleteServiceInstanceEvent extends AbstractUpdateEvent implements Event
{
	
	
	private static Logger LOG = LoggerFactory.getLogger(DeleteServiceInstanceEvent.class);
	
	
		public DeleteServiceInstanceEvent(String id,  Collection<IPrincipal> principals, long lastKnownUpdate)
	{
		super.entityId = id;
