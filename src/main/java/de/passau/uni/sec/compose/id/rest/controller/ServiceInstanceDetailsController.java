...
public class ServiceInstanceDetailsController {
private static Logger LOG = LoggerFactory.getLogger(ServiceInstanceDetailsController.class);
    ...
    public @ResponseBody ResponseEntity<Object> getUser( @RequestHeader("Authorization") String token,
    		@PathVariable(value="Id") String uid,UriComponentsBuilder builder){
    			...
    			try{
    				 ...
    				 EntityResponseMessage res = siService.getEntity(new GetServiceInstanceEvent(uid,principals));
