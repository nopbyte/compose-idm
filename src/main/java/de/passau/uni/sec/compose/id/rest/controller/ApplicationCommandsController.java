...
@Controller
@RequestMapping("/idm/application")
public class ApplicationCommandsController {

	private static Logger LOG = LoggerFactory.getLogger(ApplicationCommandsController.class);
    ...
    @RequestMapping(value = "/", method = RequestMethod.POST, consumes = "application/json")
        ...
        public  ResponseEntity<Object> createEntity(
        		@Valid  @RequestBody ApplicationCreateMessage message,UriComponentsBuilder builder,HttpServletRequest req) {
		    	...
		    	try{
    				...
    				//This method just authenticates... it doesn't do access control
		    		 ...
		    		 ApplicationResponseMessage res = (ApplicationResponseMessage) applicationService.createEntity(new CreateApplicationEvent(message,principals));
		    		 headers.setLocation(
    ...
    @ResponseStatus(HttpStatus.OK)
        ...
        public  ResponseEntity<Object> DeteEntity(
			...
			try{
				 ...
				 Collection<IPrincipal> principals = authenticator.authenticatePrincipals(LOG,cred);
	    		 applicationService.deleteEntity(new DeleteApplicationEvent(uid,principals,lastKnownUpdate));
