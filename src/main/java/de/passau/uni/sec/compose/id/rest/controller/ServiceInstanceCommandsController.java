...
@Controller
@RequestMapping("/idm/serviceinstance")
public class ServiceInstanceCommandsController {

	private static Logger LOG = LoggerFactory.getLogger(ServiceInstanceCommandsController.class);
    ...
    @RequestMapping(value = "/", method = RequestMethod.POST, consumes = "application/json")
        ...
        public  ResponseEntity<Object> createEntity( 
        		@Valid  @RequestBody ServiceInstanceCreateMessage message,UriComponentsBuilder builder,HttpServletRequest req) {
    			...
    			try{
    				...
    				//This method just authenticates... it doesn't do access control
    				 ...
    				 ServiceInstanceResponseMessage res = (ServiceInstanceResponseMessage) serviceInstanceService.createEntity(new CreateServiceInstanceEvent(message,principals));
		    		 headers.setLocation(
    ...
    @RequestMapping(value = "/{Id}", method = RequestMethod.PUT, consumes = "application/json")
        ...
        public  ResponseEntity<Object> updateEntity( @RequestHeader("Authorization") String token,
        		...
        		@PathVariable(value="Id") String uid, @Valid @RequestBody ServiceInstanceCreateMessage message) {
    	
    	HttpHeaders headers = new HttpHeaders();
    	Collection<String> credentials = new LinkedList<String>();
    	credentials.add(token);
    	credentials.add(message.getAuthorization());
    ...
    @ResponseStatus(HttpStatus.OK)
        ...
        public  ResponseEntity<Object> DeteEntity(@RequestHeader("Authorization") String token,
			...
			try{
				 ...
				 Collection<IPrincipal> principals = authenticator.authenticatePrincipals(LOG,cred);
	    		 serviceInstanceService.deleteEntity(new DeleteServiceInstanceEvent(uid,principals,lastKnownUpdate));
