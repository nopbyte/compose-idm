...
public class DeleteEntityGroupMembershipEvent extends AbstractUpdateEvent implements Event
{
	
	
	private static Logger LOG = LoggerFactory.getLogger(DeleteEntityGroupMembershipEvent.class);
	
	
		public DeleteEntityGroupMembershipEvent(String id,  Collection<IPrincipal> principals, long lastKnownUpdate)
	{
		super.entityId = id;
